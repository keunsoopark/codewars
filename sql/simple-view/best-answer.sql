# Use WHERE A IN clause instead of JOIN as you do not need A in the result schema.
# Use HAVING as you would like to filter with the target attributed made by GROUP BY clause
